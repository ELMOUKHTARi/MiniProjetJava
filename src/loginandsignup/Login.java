...
initComponents();
    ...
    private void initComponents() {
        ...
        jLabel6.setText("SUPMTI");

        jLabel7.setFont(new java.awt.Font("Comic Sans MS", 1, 16)); // NOI18N
        jLabel7.setForeground(new java.awt.Color(204, 204, 204));
        jLabel7.setText("ELMOUKHTAR Noureddine Etudiant 2 GI");
 ...
 out = new PrintWriter(new OutputStreamWriter(socket.getOutputStream(), "UTF-8"), true);
    ...
    out.println("LOGIN;" + log.getText() + ";" + pass.getText());
    ...
    if (response.contains("ok")  ) {
        ...
        JOptionPane.showMessageDialog(null, "Login ou mot de passe incorrect.", "Attention", JOptionPane.WARNING_MESSAGE);
    }
    out.close();
in.close();
socket.close();
